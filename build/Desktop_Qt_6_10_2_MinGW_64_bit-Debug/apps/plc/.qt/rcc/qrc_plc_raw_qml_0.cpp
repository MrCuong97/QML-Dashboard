...
0x0,0x0,0x1,0x9c,0x9a,0x1f,0x35,0xaa,
...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_plc_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_plc_raw_qml_0)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_plc_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_plc_raw_qml_0)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_plc_raw_qml_0)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_plc_raw_qml_0)(); }
   } dummy;
}
